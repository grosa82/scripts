...
//DEPLOYMENT
/*$("#FirstName").val('Henwen Retailer');
$("#LastName").val('Sales Tax Deployment');
$("#EmailAddress").val('henwenRetailerSalesTaxDeployment@crestfinancial.com');
$("#StreetLine1").val('1234 Henwen Sales Tax Retailer Way');
$("#City").val("Salt Lake City");
$("#StateID").val("UT");
$("#PostalCode").val(randomNumWithXDigits(5));*/
//
