...
// @exclude      http://*/RDLCReports/CollectionCommissionBucketReport.aspx
// @grant        none
...
$("#select-retailer").change(function () {
    if ($(this).val() != "1337" || callOnce == false) {
        alert("If a CC is required, you'll need to get that yourself.");
    }
});
